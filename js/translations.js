const translations = {
  fr: {
    ...
    exp0_mission_1_page: 'Conception et d\u00e9veloppement de NutriTracker, une application PWA de suivi nutritionnel par dict\u00e9e vocale (gain de perf: [INSERER METRIQUE]).',
    ...
    exp0_mission_1: 'D\u00e9veloppement de A \u00e0 Z de l\'application full-stack NutriTracker (PWA) (gain de perf: [INSERER METRIQUE])',
    ...
    tag_n8n: 'n8n',
    tag_llm_cascade: 'LLM Cascade',
    tag_supabase: 'Supabase',
    tag_pwa: 'PWA',
    tag_ai_agents: 'Agents IA',
    tag_data_engineering: 'Data Engineering',
    tag_multi_tasking: 'Multi-tasking',
    tag_inference_llm: 'Inference LLM',
    tag_linear_programming: 'Programmation Lin\u00e9aire',
    tag_ocr: 'OCR',
    tag_webhooks: 'Webhooks & API',
  ...
  en: {
    ...
    exp0_mission_1_page: 'Design and development of NutriTracker, a PWA for nutrition tracking via voice dictation (perf gain: [INSERER METRIQUE]).',
    ...
    exp0_mission_1: 'End-to-end development of the full-stack NutriTracker application (PWA) (perf gain: [INSERER METRIQUE])',
    ...
    tag_data_engineering: 'Data Engineering',
    tag_multi_tasking: 'Multi-tasking',
    tag_inference_llm: 'LLM Inference',
    tag_linear_programming: 'Linear Programming',
    tag_ocr: 'OCR',
    tag_webhooks: 'Webhooks & API',
